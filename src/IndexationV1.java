...
public class IndexationV1 {
	...
	public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException 
	{
		...
		saveInvertedFile(getInvertedFile(ReadXMLFile.listDocuments, new FrenchStemmer(new File(STOPWORDS_FILENAME))),new File(DIRNAME+"/../fichierInverseData2015.txt"));
